...
def result = QPEx.runPlugin('qupath.imagej.detect.cells.PositiveCellDetection', '{"detectionImage":"Blue","requestedPixelSizeMicrons":0.2035,"backgroundRadiusMicrons":9.0,"backgroundByReconstruction":true,"medianRadiusMicrons":0.1,"sigmaMicrons":2.02,"minAreaMicrons":0.7,"maxAreaMicrons":400.0,"threshold":5.0,"watershedPostProcess":true,"cellExpansionMicrons":2.119424460431654,"includeNuclei":true,"smoothBoundaries":true,"makeMeasurements":false,"thresholdCompartment":"Nucleus: Blue max","thresholdPositive1":17.915556079726382,"thresholdPositive2":11.194244604316546,"thresholdPositive3":5.1366906474820135,"singleThreshold":true}')
println "# Detekcja komórek zakończona: ${result}"

// Subkomórkowa detekcja
def subcellularResult = QPEx.runPlugin('qupath.imagej.detect.cells.SubcellularDetection', '{"detection[Channel 1]":65.0,"detection[Channel 2]":50.0,"detection[Channel 3]":-1.0,"doSmoothing":true,"splitByIntensity":true,"splitByShape":true,"spotSizeMicrons":0.7,"minSpotSizeMicrons":0.5,"maxSpotSizeMicrons":2.0,"includeClusters":true}')
